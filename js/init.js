{
    ...
    async function ganar() {
        ...
        setTimeout(ganasteMinijuego, 2300);
        janelaPopUp.abre("2", 'p green', 'Ganaste', 'Obtienes un punto', iniciaJuego, 'Cerrar')
    }
    ...
    async function perder() {
        ...
        janelaPopUp.abre("2", 'p red', 'Perdiste', 'Termina tu turno', iniciaJuego, )
    }
